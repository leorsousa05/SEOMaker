...
echo "\n";
require __DIR__ . '/php/PageRobotsTest.php';
echo "\n";
require __DIR__ . '/php/PageCanonicalTest.php';
echo "\n";
require __DIR__ . '/php/PageOgImageTest.php';
echo "\n";
require __DIR__ . '/php/FaqSchemaTest.php';
echo "\n";
require __DIR__ . '/php/ImageLazyAltTest.php';
echo "\n";
require __DIR__ . '/php/BreadcrumbTemplateTest.php';
echo "\n";
require __DIR__ . '/php/BreadcrumbSchemaTest.php';
echo "\n";
require __DIR__ . '/php/SitemapRobotsCacheTest.php';
echo "\n";
require __DIR__ . '/php/CanonicalRedirectTest.php';
echo "\n";
